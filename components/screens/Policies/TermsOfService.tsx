...
const TermsOfServiceScreen = () => {
	return (
		...
		>
			<strong>OVERVIEW</strong> <br /> This website is operated by Drums That
			Knock. Throughout the site, the terms &apos;we&apos;, &apos;us&apos; and
			&apos;our&apos; refer to Drums That Knock. Drums That Knock offers this
			...
			acceptance of those changes. <br /> <br /> Our store is hosted on Shopify
			Inc. They provide us with the online e-commerce platform that allows us to
			sell our products and services to you. <br /> <br />{' '}
			...
			tools. <br /> Any use by you of optional tools offered through the site is
			...
			the relevant third-party provider(s). <br /> We may also, in the future,
			...
			shall also be subject to these Terms of Service. <br /> <br />{' '}
			...
			by you or any third-party. <br /> <br />{' '}
			<strong>SECTION 10 - PERSONAL INFORMATION</strong> <br /> Your submission
			...
			non-infringement. <br /> In no case shall Drums That Knock, our directors,
			...
			way to your use of the service or any product, including, but not limited
			...
			<br /> <strong>SECTION 14 - INDEMNIFICATION</strong> <br /> You agree to
			indemnify, defend and hold harmless Drums That Knock and our parent,
			...
			the Terms of Service should be sent to us at decap@drumsthatknock.com.
		</Wrapper>
	);
};
