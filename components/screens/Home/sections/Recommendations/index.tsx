        ...
        >
          ...
          <p>
            <q className="text-primary-2">
              When I put out Drums That Knock, producers loved it, and it blew
              up. It created a new standard. When you hear those hard hitting,
              punchy kicks come through Spotify... that&apos;s Drums That Knock,
              and that&apos;s Plugins that knock.
            </q>
            <br />
            <cite>- Decap</cite>
          </p>
